"""
Django settings for busymuslim project.
...
ADMINS =(('admin','busymuslim@gmail.com'),)
EMAIL_USE_TLS = True
...
AUTH_USER_MODEL = 'busymuslimapp.Profile'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'busymuslimapp.context_processors.google_analytics',
...
WSGI_APPLICATION = 'busymuslim.wsgi.application'
...
AWS_STORAGE_BUCKET_NAME = 'busymuslim'
...
MEDIA_ROOT = '/www/busymuslim/media'
MEDIA_URL = '/media/'
